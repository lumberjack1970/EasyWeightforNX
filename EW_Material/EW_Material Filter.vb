...
' Journal desciption: you can control the visibility of specific solid bodies on your screen using the attributes assigned before.
...
Module Module1
    Private Const _attributeTitle As String = "EW_Material"
    ...
    Sub UpdateView(ByRef theSession As Session, workPart As Part, attributeValue As String)
        ...
        For Each body As Body In bodies
            ...
            Try
                attrInfo = body.GetUserAttribute(_attributeTitle, NXObject.AttributeType.String, -1)
                If _attributeValue = "empty" Then
                    bodiesToHide.Add(body)
                ElseIf attrInfo.StringValue = _attributeValue Then
    ...
    Sub Main()
        ...
        Try
            Dim myAttributeInfo = workPart.GetUserAttribute(_attributeTitle, NXObject.AttributeType.String, -1)
        ...
        AddHandler myForm.ApplyButtonClicked, Sub(sender, e)
                                                  ...
                                                  workPart.SetUserAttribute(_attributeTitle, -1, _attributeValue, Update.Option.Now)
                                              End Sub
...
Public Class Form1
    ...
    Else
        ' You might want to display a warning to the user to select an item
    End If
	End Sub

    Private Sub btnQuit_Click(sender As Object, e As EventArgs) Handles btnQuit.Click
    ' Explicitly call the update function here to verify if this is causing the intended behavior
    Dim theSession As Session = Session.GetSession()
